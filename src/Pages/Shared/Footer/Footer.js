...
const Footer = () => {
  ...
  return (
    <footer className="relative">
      <div className="pt-[54px] lg:pt-[74px] pb-[69px] lg:pb-[45px]  bg-base-200 bg-transparent lg:bg-footerBg bg-cover bg-center bg-no-repeat absolute bottom-0 w-full">
