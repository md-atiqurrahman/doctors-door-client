...
const Service = ({ image, title, description }) => {
  return (
    <div className="w-[1/3]  rounded-[18px] bg-base-100 shadow-customShadow py-[40px] px-[20px] lg:px-[56px]">
      <div className="flex flex-col justify-center items-center">
        <figure>
          <img src={image} alt="" className="w-[115px] h-[115px]" />
        </figure>
        <div className="card-body pt-[34px] pb-0 px-0 items-center text-center">
          <h2 className="card-title text-accent text-[20px] font-semibold">
            {title}
          </h2>
